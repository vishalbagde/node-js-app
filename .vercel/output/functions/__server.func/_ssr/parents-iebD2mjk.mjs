...
function Page() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminLayout, { title: "Parents", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CrudTable, { table: "parents", title: "parent", orderBy: {
    column: "created_at"
  }, searchFields: ["full_name", "mobile"], emptyForm: {
    full_name: "",
    mobile: "",
    relation: "Father"
  }, beforeSave: (s) => ({
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Relation", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "h-10 rounded-md border bg-background px-3 text-sm", value: s.relation ?? "Father", onChange: (e) => set({
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Occupation", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: s.occupation ?? "", onChange: (e) => set({
        occupation: e.target.value
      }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Linked student", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { className: "h-10 rounded-md border bg-background px-3 text-sm", value: s.student_id ?? "", onChange: (e) => set({
